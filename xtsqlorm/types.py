...
"""
==============================================================
Description  : 自定义SQLAlchemy类型定义
Author       : sandorn sandorn@live.cn
LastEditTime : 2025-10-23 16:00:00
Github       : https://github.com/sandorn/xtsqlorm

本模块提供SQLAlchemy ORM的自定义类型定义,包括:
- JsonEncodedDict: JSON编码字典类型
- EnumType: 枚举类型装饰器
- UTCDateTime: UTC时间类型装饰器
==============================================================
"""
...
__all__ = ['EnumType', 'JsonEncodedDict', 'UTCDateTime']
